...
def extract_visual_features():
    ...
    im_data_dir = "../target_ori_first/image_train/210203"
    ...
    saver.restore(sess, "../train/cae_original_first_checkpoints/model")         # restore previously saved variables
...
def main():
    ...
    save_dir = "../train/cae_original_first_checkpoints/model"
